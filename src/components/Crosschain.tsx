            ...
            <div className="overflow-hidden relative py-[300px] w-full">
                ...
                <div className="relative w-full lg:mb-0 text-black text-center">
                    <div className="z-10 relative m-auto w-full lg:w-3/5">
                        <h2 className="backup-headline crosschain-headline font-black ms500 text-white text-[100px] text-center tracking-[-0.05em] leading-[120px] w-full absolute left-0 top-[-35px]">Swap</h2>
                    ...
                    <div className="font-bold list-none relative grid md:grid-cols-4 z-10 p-16 uppercase crosschain-stats">
                        ...
                        <div>
                            ...
                            <div className="grid grid-cols-4 gap-5 max-w-52">
                                ...
                                <div className="opacity-5 hover:opacity-100"><Image width={18} height={18} src="/btc.png" alt="btc" /></div>
                                <div className="opacity-5 hover:opacity-100"><Image width={18} height={18} src="/polygon.png" alt="polygon" /></div>
                                <div className="opacity-5 hover:opacity-100"><Image width={18} height={18} src="/avalanche.png" alt="avalanche" /></div>
                                <div className="opacity-5 hover:opacity-100"><Image width={18} height={18} src="/optimism.png" alt="optimism" /></div>
                                <div className="opacity-5 hover:opacity-100"><Image width={18} height={18} src="/fantom.png" alt="fantom" /></div>
                                <div className="opacity-5 hover:opacity-100"><Image width={18} height={18} src="/solana.png" alt="solana" /></div>
                                <div className="opacity-5 hover:opacity-100"><Image width={18} height={18} src="/arbitrum.png" alt="arbitrum" /></div>
                                <div className="opacity-5 hover:opacity-100"><Image width={18} height={18} src="/kcc.png" alt="kcc" /></div>
                                <div className="opacity-5 hover:opacity-100"><Image width={18} height={18} src="/telos.png" alt="telos" /></div>
                                <div className="opacity-5 hover:opacity-100"><Image width={18} height={18} src="/klaytn.png" alt="klaytn" /></div>
                                <div className="opacity-5 hover:opacity-100"><Image width={18} height={18} src="/aurora.png" alt="aurora" /></div>
                                <div className="opacity-5 hover:opacity-100"><Image width={18} height={18} src="/moonbeam.png" alt="moonbeam" /></div>
                                <div className="opacity-5 hover:opacity-100 text-2xl text-start"><span>+</span></div>
                            </div>
                        </div>
                    </div>
                </div>
